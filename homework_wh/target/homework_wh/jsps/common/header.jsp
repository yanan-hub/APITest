...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath }/static/My97DatePicker/skin/WdatePicker.css">
        ...
        <script src="${pageContext.request.contextPath}/static/assets/layer/extend/layer.ext.js" type="text/javascript"></script>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/static/My97DatePicker/lang/zh-cn.js"></script>
